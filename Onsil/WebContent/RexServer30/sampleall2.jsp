...
function fnOpen() {
	...
	// 필수 - 레포트 파일명
	oReport.rptname = "AEXResDocCDLXDiv";
	...
	oReport.connectname= "oracle2";
	//oReport.connectname= "ora1";
	//oReport.connectname= "sql1";

	// 옵션 - 레포트 파라메터
	oReport.param("param3").value = "param3";
	oReport.param("param2").value = "param2";
	oReport.param("param").value = "param3";
	...
	//oReport.type = "file";
	//oReport.datatype = "xml";
	//oReport.xpath = "database/dataset/datatable/rexrow";
	...
	//oReport.path = "C:\\Users\\nueur\\Downloads\\0_인천대 리포트 파일_test\\sgsm0900_prn02.xml";
	...
	*/
	...
	/*
	background 넣기 arg1 : 용지 종류, arg2 : 용지 방향, arg3 : reb경로
	용지 종류 --------------------------------------------------------
	0 - A3, 297 x 420 mm 
	1 - A4, 210 x 297 mm 
	2 - A5, 148 x 420 mm 
	3 - B4, 257 x 364 mm 
	4 - Envelope B4 , 250 x 353 mm 
	5 - B5, 182 x 257 mm 
	6 - Envelope B5 , 176 x 250 mm 
	7 - Envelope B6 , 176 x 125 mm 
	8 - Envelope C3 , 324 x 458 mm 
	9 - Envelope C4 , 229 x 324 mm 
	10 - Envelope C5 , 162 x 229 mm 
	11 - Envelope C65 , 114 x 229 mm 
	12 - Envelope C6 , 114 x 162 mm 
	13 - C size sheet , 17 x 22 in 
	14 - Envelope DL , 110 x 220 mm 
	15 - D size sheet , 22 x 34 in 
	16 - E size sheet , 34 x 44 in 
	17 - Executive , 7 1/2 x 10 1/2 in 
	18 - Folio, 8 1/2 x 13 in 
	19 - German Legal Fanfold , 8 1/2 x 13 in 
	20 - German Standard Fanfold , 8 1/2 x 12 in 
	21 - Italy , 110 x 230 mm 
	22 - Ledger , 17 x 11 in 
	23 - Leger , 8 1/2 x 14 in 
	24 - Letter , 8 1/2 x 11 in 
	25 - Monarch , 3 7/8 x 7 1/2 in 
	26 - Note , 8 1/2 x 11 in 
	27 - Envelope #10 , 4 1/8 x 9 1/2 in 
	28 - Envelope #11 , 4 1/2 x 10 3/8 in 
	29 - Envelope #12 , 4 1/2 x 11 in 
	30 - Envelope #14 , 5 x 11 1/2 in 
	31 - Envelope #9 , 3 7/8 x 8 7/8 in 
	32 - Envelope Personal , 3 5/8 x 6 1/2 in 
	33 - Quarto , 215 x 275 mm 
	34 - 10 x 14 , 10 x 14 in 
	35 - 11 x 17 , 11 x 17 in 
	36 - U.S Standard Fanfold, 14 7/8 x 11 in 
	37 - Tabloid , 11 x 17 in 
	255 - User Define
	oReport.background("1","portrait", "c:\\test\\a.reb"); // 용지 종류, 용지 방향, reb경로
	oReport.background("2","landscape", "c:\\test\\b.reb");
	*/
	oReport.iframe(ifrmRexPreview1);
	//oReport.open();
...
function fnReportEvent(oRexCtl, sEvent, oArgs) {
	if (sEvent == "init") {
		var dt = new Date(); console.log("init : "+dt);
		
	} else if (sEvent == "finishdocument") { var dt = new Date(); console.log("finishdocument : "+dt);
	} else if (sEvent == "finishprint") {
	} else if (sEvent == "finishexport") {var dt = new Date(); console.log("finishexport : "+dt);
	...
	} else if (sEvent == "buttonexporthwpclickbefore") {var dt = new Date(); console.log("buttonexporthwpclickbefore : "+dt);
	} else if (sEvent == "buttonexporthwpclickafter") {  var dt = new Date(); console.log("buttonexporthwpclickafter : "+dt);
